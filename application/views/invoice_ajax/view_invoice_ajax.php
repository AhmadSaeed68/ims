<div class="well"><h2> Invoice Detail</h2></div>
                 ...
                 <span> <a href="<?php echo base_url() ?>pdf/single_invoice_pdf/<?=$data['invoice_code']?>" class="w3-right"> <span class="fa fa-file-pdf-o w3-text-red fa-2x"></span> Download</a></span>
