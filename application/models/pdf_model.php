...
return $query->result_array();
        ...
        function single_invoice_pdf($invoice_code,$user_id){
            $query=$this->db
            ->query('SELECT * FROM po_invoice inner JOIN po_invoice_detail ON po_invoice_detail.invoice_code=po_invoice.invoice_code WHERE po_invoice.invoice_code ="'.$invoice_code.'" AND po_invoice_detail.user_id="'.$user_id.'" and po_invoice.user_id="'.$user_id.'"');
return $query->result_array();
        }
