...
?>
 ...
 <div class="row">
 <button type="button" class="btn btn-outline btn-primary btn-xs" id="add_dept" data-toggle="modal" data-target="#myModal">Add Department</button>
 </div>
 <!-- /.row -->
   <div class="row">
                <div class="col-lg-12">
...
$(document).ready(function(){
     table = $('#table').DataTable({
        "processing":true,
                    ...
                    "ajax":{
                        "url":"<?php echo site_url('department_controller/department-by-json')?>",
                        "type":"POST",
                        "data":function(data){
