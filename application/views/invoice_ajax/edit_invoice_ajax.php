...
<form action="" class="order" id="invoice_update">
    ...
    <input type="hidden"value='<?php echo $data['invoice_code'];?>' required  name="invoice_code" id="invoice_code">
    <input type="hidden" name="po_code[]" value='<?php echo $data['po_code'];?>' required  id="po_code">
    <input type="hidden"  value='<?php echo $data["item_code"];?>' required name="item_code" id="item_code">
    <div class="row">
        <h3 class="w3-center">Edit Invoice Data</h3>
    </div>
    <div class="row">
        <div class="col-sm-8">
            <div class="col-sm-4">
                
                <span name="po_code[]" id="po_code">PoCode: <b><?= $data['po_code']?></b></span><br>
    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            <div class="form-group col-md-8">
                ...
                <?php echo form_textarea(['name'=>'invoice_description','rows'=>'4','placeholder'=>'item Description',
