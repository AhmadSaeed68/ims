    ...
    ?>
        ...
        <div class="panel-body">
            ...
            <thead>
        <tr>
            <th><i class="glyphicon glyphicon-bookmark"></i>item Id</th>
            <th><i class=" 
            glyphicon glyphicon-user w3-text-blue"></i>category ID</th>
        <th><i class="glyphicon glyphicon-open-file w3-text-red"></i>Category Name</th>
        <th><i class="glyphicon glyphicon-open-file w3-text-red"></i>Item Name</th>
        <th><i class="glyphicon glyphicon-open-file w3-text-red"></i>item Code</th>
        <th><i class="glyphicon glyphicon-open-file w3-text-green"></i>Item Description</th>

        <th><i class="glyphicon glyphicon-open-file w3-text-red"></i>Item Status</th>
        <th><i class="glyphicon glyphicon-open-file w3-text-red"></i>Edit</th>
