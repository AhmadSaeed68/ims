            ...
            <div class="modal-content">
                ...
                <legend class="w3-center w3-padding">
                   ...
                   <div class="row">
                    ...
                    <div class="form-group col-sm-4">
                    <label for="po_desc" class="w3-center">Po Description</label>
...
fa fa-newspaper-o w3-text-blue"></span> Order Report</th>
                ...
                <?php foreach($order_data as $data):?>
                    ...
                    <span class="order_report_span" id="<?php echo $report=$data['order_report'];?>"></span> <?php $report=$data['order_report']; if($report=="recived"){
                         echo "<span class='w3-teal'>Recived</span>";
                     }else{
                        echo "<span class='w3-orange'>Pending</span>";
                     }?>
                     </td>

                        <td><input type="button" class="btn btn-info btn-sm edit" value="Edit" id="<?php echo $data['po_code']; ?>"></td>
                        <td>
                        <button class="btn btn-danger btn-sm delete" id="<?php echo $data['po_code']; ?>" data-status="<?=$data['status']?>">Delete</button>
                        </td>
